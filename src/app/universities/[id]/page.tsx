  ...
  if (!uni) {
    return (
      <div className="py-24 text-center">
        ...
        <Button asChild><Link href="/universities"><ArrowLeft className="mr-2 h-4 w-4" /> Back to Universities</Link></Button>
      </div>
    )
  }
